...
const ParadiseCountryPage = () => {
  return (
    <div className="bg-white">
      <Head>
        <title>Play Coast - Paradise Country, Gold Coast</title>
      </Head>
      <div
        ...
        <section className="py-12">
          <div className="container">
            ...
            <ol className="list-decimal">
              ...
              <li className="mb-4">
                Self-Drive: If you have access to a car, you can drive to Paradise Country. Follow the signs and directions to Pacific Motorway (M1) and take Exit 60 to Paradise Country. On-site parking is available for free.
              </li>
            </ol>
            <p>
