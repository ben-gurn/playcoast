    ...
    >
      ...
      <section className="">
        ...
        <p className="mb-6 font-bold">
          Sea World is an iconic marine theme park located in Main Beach, Gold Coast, offering a thrilling and educational experience for visitors of all ages. Spanning over 50 hectares, this captivating park combines entertainment, conservation, and unforgettable encounters with marine life.
        </p>
        <p className="mb-6">
